...
public class AllWindSpeedSensorServlet extends HttpServlet {
	public void doGet(HttpServletRequest req,HttpServletResponse resp) throws ServletException,IOException{
		...
		String sensorID4 = "urn:liesmars:object:feature:WindSpeedSensor4";
		String sensorID5 = "urn:liesmars:object:feature:WindSpeedSensor5";
			 ...
			 try {
			  ...
			  try {
				...
				for(int i=0;i<IDList4.size();i++){
					...
					if(s9.contains("WindSpeed")){
						 obsPro8=s9;
					}
					if(s10.contains("WindSpeed")){
						 obsPro7=s10;
					}
				}
			} catch (NetworkException e2) {
	...
	//获取观测			
			  ...
			  try {
				...
				for(int i=0;i<IDList5.size();i++){
					...
					if(s11.contains("WindSpeed")){
						 obsPro10=s11;
					}
					if(s12.contains("WindSpeed")){
						 obsPro9=s12;
					}
				}
			} catch (NetworkException e2) {
