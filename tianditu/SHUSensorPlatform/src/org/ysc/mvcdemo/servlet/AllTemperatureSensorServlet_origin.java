...
public class AllTemperatureSensorServlet extends HttpServlet {
	public void doGet(HttpServletRequest req,HttpServletResponse resp) throws ServletException,IOException{
		String path = "temperature-test-demo.jsp" ;
		String sensorID1 = "urn:liesmars:object:feature:TemperatureSensor1";
		String sensorID2 = "urn:liesmars:object:feature:TemperatureSensor2";
		String sensorID3 = "urn:liesmars:object:feature:TemperatureSensor3";
		String sensorID4 = "urn:liesmars:object:feature:TemperatureSensor4";
		String sensorID5 = "urn:liesmars:object:feature:TemperatureSensor5";
		 ...
		 try {
		  ...
		  try {
			...
			for(int i=0;i<IDList2.size();i++){
				...
				if(s4.contains("Temperature")){
					 obsPro4=s4;
				}
				if(s5.contains("Temperature")){
					 obsPro3=s5;
				}
			}
		} catch (NetworkException e2) {
	  ...
	  PointTimePair pointTimePair3=null;
			 ...
			 try {
			  ...
			  try {
				...
				for(int i=0;i<IDList3.size();i++){
					...
					if(s7.contains("Temperature")){
						 obsPro6=s7;
					}
					if(s8.contains("Temperature")){
						 obsPro5=s8;
					}
				}
			} catch (NetworkException e2) {
			 ...
			 try {
			  ...
			  try {
				...
				for(int i=0;i<IDList4.size();i++){
					...
					if(s9.contains("Temperature")){
						 obsPro8=s9;
					}
					if(s10.contains("Temperature")){
						 obsPro7=s10;
					}
				}
			} catch (NetworkException e2) {
		  ...
		  String value4=sensorDataPair7.getValue()+"  "+unit;
	...
	//获取观测			
			  ...
			  try {
				...
				for(int i=0;i<IDList5.size();i++){
					...
					if(s11.contains("Temperature")){
						 obsPro10=s11;
					}
					if(s12.contains("Temperature")){
						 obsPro9=s12;
					}
				}
			} catch (NetworkException e2) {
		  ...
		  String value5=sensorDataPair9.getValue()+"  "+unit;
