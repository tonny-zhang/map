...
public class CopyOfAllHumiditySensorServlet extends HttpServlet {
	public void doGet(HttpServletRequest req,HttpServletResponse resp) throws ServletException,IOException{
		  ...
		  PointTimePair pointTimePair5=null;
		    ...
		    ResultOneObsPro sensorDataPair10 = null;
			 ...
			 try {
			  ...
			  name5=sensorID4.substring((sensorID5.lastIndexOf(":")+1) ,sensorID5.length()) ;
			  String obsPro9=null;
			  ...
			  try {
				...
				e2.printStackTrace();
		          ...
		          try {
					sensorDataPair8 = sosClientLite.getObservationLatestOneObsPro("LIESMARS",sensorID5,obsPro10);
				} catch (OtherException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				} catch (OfferingIDNotExistException e1) {
	  ...
	  req.setAttribute("obsPro4",obsPro4);
