...
public class GetSensorLatestPosition {
	...
	public static void main(String[] args) {
		...
		GetSensorLatestPosition pos=new GetSensorLatestPosition();
		pos.Do();
   ...
   public void Do(){
	   ...
	   //sosClientLite.setDefaultOfferingID("temperature");
		...
		try {
		 ...
		 pointTimePair=sosClientLite.getSensorLatestPosition("urn:liesmars:object:feature:TemperatureSensor4");
