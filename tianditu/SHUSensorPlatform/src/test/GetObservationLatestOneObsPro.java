...
public class GetObservationLatestOneObsPro {
	...
	public static void main(String[] args) {
		...
		try {
			sensorDataPair1 = sosClientLite.getObservationLatestOneObsPro("LIESMARS",
					"urn:liesmars:object:feature:TemperatureSensor1",
					"urn:liesmars:def:phenomenon:LIESMARS:1.0.0:Temperature");
			sensorDataPair2 = sosClientLite.getObservationLatestOneObsPro("LIESMARS",
					"urn:liesmars:object:feature:Platform:Station:Weather:sta-a001",
					"urn:liesmars:def:phenomenon:LIESMARS:1.0.0:AirTemperature");
			sensorDataPair3 = sosClientLite.getObservationLatestOneObsPro("LIESMARS",
					"urn:liesmars:object:feature:Platform:Station:Weather:sta-a001",
					"urn:liesmars:def:phenomenon:LIESMARS:1.0.0:WindSpeed");
			...
			System.out.println(sensorDataPair2.getValue());
			System.out.println(sensorDataPair3.getValue());
